...
class ControlThread:
    ...
    def _handle_claw_button(self, button: int):
        """
        Button → claw command table.
        Sends servo angle commands directly as "servo:<id>,<angle>"
        """
        commands = {
    ...
    def _build_command(self, ctrl: dict) -> str:
        ...
        # ── FIX: Arduino expects "c <val>,<val>,..." not "c,<val>,..."  ──
        # Also removed the trailing ",0,0" — Arduino only reads 8 thrusters
