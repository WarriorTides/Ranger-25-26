...
joystick_present = pygame.joystick.get_count() > 0.  # Check if a joystick is present
if joystick_present: 
    joystick = pygame.joystick.Joystick(0)
    joystick.init()
    print("Joystick connected and ready!") # Initialize the joystick if it is present
else:
    print("No joystick detected. Claw control disabled.") # If no joystick is detected, print a message and continue running the program


async def claw(): # Define the claw function
